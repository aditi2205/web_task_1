...
if (isset($_POST["reg_user"])) {
  ...
  if (count($errors) == 0) {
    ...
    $query = "INSERT INTO users (username, email, password, rollno, address) 
          VALUES('$username', '$email', '$password', '$rollno', '$address')";
...
if (isset($_POST['edit_address'])) {
  ...
  if (count($errors) == 0) {
    $password = md5($password);
    $query1 = "UPDATE users SET address='$new_addr' WHERE address='$old_addr' AND username='$username'";
...
if (isset($_POST['edit_password'])) {
  ...
  if (count($errors) == 0) {
    ...
    $query1 = "UPDATE users SET password='$password2' WHERE password='$password1' AND username='$username' ";
    if ($db->query($query1) === TRUE) {
    echo "Record updated successfully";
